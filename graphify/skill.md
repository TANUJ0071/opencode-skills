---
name: graphify
description: AI knowledge graph skill - turn any code, docs, papers, images into interactive knowledge graph with community detection. Use /graphify to analyze codebases.
trigger: /graphify
---
